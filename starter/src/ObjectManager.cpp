...
void ObjectManager::UpdateAll(unsigned int screenWidth, unsigned int screenHeight, const glm::mat4 &viewMatrix, const glm::vec3 &cameraPos)
{
    for (size_t i = 0; i < m_objects.size(); i++)
    {
        m_objects[i]->Update(screenWidth, screenHeight, viewMatrix, cameraPos);
    }
}
